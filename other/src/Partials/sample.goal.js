...
//    var $quantityForm        = Y.compChild($main, '.quantity-selection');
    var $quantityValue       = $quantityForm.child('[name=quantity-value]');
    var $quantityUnit        = $quantityForm.child('[name=quantity-unit]');

//    var $articleSummary      = Y.compChild($main, '.article-summary');
//  var $skuText        = Y.optChild($main, $articleSummary, '.sku-text');
    var $skuId               = $articleSummary.child('.sku-id');
    var $skuAvailable        = $articleSummary.child('.is-available');
    var $skuNotAvailable     = $articleSummary.child('.is-not-available');
    var $skuNotAvailableLink = $skuNotAvailable.child('.article-name');

//    var $submitArea          = Y.compChild($main, '.article-shop');
    var $submitConfirm       = $submitArea.child('.comp-ajax-simple-action').has('.confirm');
    var $submitCancel        = $submitArea.child('.is-picker-cancel');
    var $submitCart          = $submitArea.child('.comp-ajax-simple-action').has('.add-to-cart');
    var $submitList          = $submitArea.child('.comp-ajax-tooltip-select').has('.add-to-list');
//    var $submitActions       = $submitConfirm.add($submitCart).add($submitList);


    var getUrl               = $main.data('get-url');
    ...
    var obj = {
        ...
        expose: {
            ...
            getArticleSelectionData: getArticleSelectionData,
            disableSubmitArea: disableSubmitArea,
            emitAddedToCart: emitAddedToCart,
            emitAddedToList: emitAddedToList,
            emitQuantityUpdated: emitQuantityUpdated,
            enableSubmitArea: enableSubmitArea,
            enableQuantitySelection: enableQuantitySelection,
            loadQuantityDetails: loadQuantityDetails,
            onAlways: onAlways,
            onFail: onFail,
            onQuantityDetailsDone: onQuantityDetailsDone,
            onUnitSelectedChange: onUnitSelectedChange,
            showAvailability: showAvailability,
            toggleSubmitArea: toggleSubmitArea
        }
    };
